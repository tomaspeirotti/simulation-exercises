...
import guille.eventos.EventoFinSelloRechazado;
 ...
 */
public class SelloRechazadoGenerator {
    ...
    public static void generate(Date horaActual, EmpleadoRegistro empleadoRegistro) {
        ...
        empleadoRegistro.setRandomSelloRechazado(randomUltimaGeneracion);
        empleadoRegistro.setTiempohastaProxFinSelloRechazado(demoraUltimaGeneracion);
        empleadoRegistro.setHoraProxFinSelloRechazado(horaUltimaGeneracion.getTime());
        MainLoop.getQueue().add(new EventoFinSelloRechazado(empleadoRegistro, hora));
    }
